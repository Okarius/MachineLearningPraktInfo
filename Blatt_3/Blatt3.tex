...
Nach der Klassifikation mit der Annahme, dass es sich bei den Kenndaten um eine multivariate Normalverteilung (und keine unabhängigen Daten) handelt, konnten alle Schwertlinien korrekt klassifiziert werden.
Die getroffene Annahme scheint die Realität besser zu treffen.

Zuvor wurden geringe Klassifikationsfehler  bei Versicolor und Verginica gemacht (10\% bzw. 5\%). (Diese Aussagen sind jedoch mit Vorsicht zu genießen, da es sich um einen sehr kleinen Datensatz handelt.)
\end{document}
