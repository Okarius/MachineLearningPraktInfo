...
stringsValue= [{'SepLen'}; {'SepWdt'};{'PetLen'};{'PetalWdt'}];
for i=1:4
    str1 = strcat('trainST',stringsValue{i});
    str2 = strcat('trainVC',stringsValue{i});
    str3 = strcat('trainVG',stringsValue{i});
...
subplot(2,2,1);
hold on;
h1=scatter(traindata_setosa(:,4),traindata_setosa(:,2),'r');
...
subplot(2,2,2);
hold on;
h1=scatter(traindata_setosa(:,3),traindata_setosa(:,1),'r');
...
subplot(2,2,3);
hold on;
h1=scatter(traindata_setosa(:,3),traindata_setosa(:,4),'r');
h2=scatter(traindata_verginica(:,3),traindata_verginica(:,4),'g');
h3=scatter(traindata_versicolor(:,3),traindata_versicolor(:,4),'b');
...
subplot(2,2,4);
hold on;
h1 = scatter(traindata_setosa(:,1),traindata_setosa(:,2),'r');
